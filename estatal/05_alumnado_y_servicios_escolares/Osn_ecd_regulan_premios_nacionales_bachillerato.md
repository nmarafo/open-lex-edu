...
La introducción, más recientemente, de las modificaciones del currículo, la organización, los objetivos y programas del Bachillerato conforme al calendario establecido en la disposición final quinta de la [Ley Orgánica 8/2013](../03_ordenacion_curricular_y_ensenanzas/LO462_2016_ecd_regula_procedimiento_incorporacion_alumnado_curso.md), de 9 de diciembre, para la mejora de la calidad educativa, obligan ahora a modificar la regulación de los Premios Nacionales, por cuanto la estructura de las materias que se estudian en el primer y segundo cursos de Bachillerato ha cambiado sustancialmente y, por tanto, resulta necesario definir la plasmación de dichos cambios en las pruebas que se vayan a realizar a partir de este momento.
