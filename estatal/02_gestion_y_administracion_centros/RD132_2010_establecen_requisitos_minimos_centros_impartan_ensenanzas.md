...
relaciones:
  ...
  - norma_id: norm-es-lo-2-2006
    titulo_origen: Título IV
    articulos_origen:
    - D. Adicional séptima. Centros sometidos al Derecho común.
    articulos_destino:
    - Art. 24
  - norma_id: norm-es-lo-8-1985
    titulo_origen: Título IV
...
Despachos de dirección, de actividades de coordinación y de orientación. Espacios destinados a la administración. Sala de profesores adecuada al número de profesores. Espacios apropiados para las reuniones de las asociaciones de alumnos y de madres y padres de alumnos, en el caso de centros sostenidos con fondos públicos. Aseos y servicios higiénico-sanitarios adecuados al número de puestos escolares, a las necesidades del alumnado y del personal educativo del centro, así como aseos y servicios higiénico-sanitarios adaptados para personas con discapacidad en el número, proporción y condiciones de uso funcional que la legislación aplicable en materia de accesibilidad establece. Espacios necesarios para impartir los apoyos al alumnado con necesidades específicas de apoyo educativo.
...
4. Los requisitos de instalaciones podrán flexibilizarse de acuerdo con lo establecido en el artículo 20 y la.

disposición adicional tercera de este real decreto.
...
a) Un aula por cada unidad con una superficie adecuada al número de puestos escolares autorizados y en todo caso, con un mínimo de 2 metros cuadrados por puesto escolar. b) Una sala polivalente de 30 metros cuadrados.
...
b) Un espacio por cada seis unidades para desdoblamiento de grupos y otro para actividades de apoyo y refuerzo pedagógico. c) Una sala polivalente, con una superficie adecuada al número de puestos escolares autorizados, que podrá compartimentarse con mamparas móviles.
...
Dos aulas diferenciadas dotadas de las instalaciones adecuadas para la enseñanza de las materias de modalidad cuando se imparta la vía de Artes Plásticas, Imagen y Diseño. Un aula de música cuando se imparta la vía de Música y Artes Escénicas.
...
de los requisitos de instalaciones para los centros docentes que. impartan distintas enseñanzas en el mismo edificio o recinto escolar.
...
- **Desarrolla**: [**RD659_2023 Ordenacion General de la Formacion Profesional**](../03_ordenacion_curricular_y_ensenanzas/RD659_2023_desarrolla_ordenacion_sistema_formacion_profesional.md) desde *(Título IV, Art. 13)*
...
- **Fundamentado en**: [**LO2_2006 Ley Organica de Educacion**](../01_marco_normativo_general_y_organico/LO2_2006_educacion_texto_consolidado_modificaciones_lomloe.md) (Art. 24) desde *(Título IV, D. Adicional séptima. Centros sometidos al Derecho común.)*
- **Fundamentado en**: [**LO8_1985 Ley Reguladora del Derecho a la Educacion (LODE)**](./LO8_1985_reguladora_derecho_educacion.md) (Art. 24) desde *(Título IV, D. Adicional séptima. Centros sometidos al Derecho común.)*
- **Fundamentado en**: [**BOE-A-2021-20113**](../03_ordenacion_curricular_y_ensenanzas/LO721_2021_correccion_errores_orden_efp_modifica_orden.md) (Art. 24) desde *(Título IV, D. Adicional séptima. Centros sometidos al Derecho común.)*
- **Fundamentado en**: [**BOE-A-2010-12201**](../05_alumnado_y_servicios_escolares/LO2058_2010_edu_regulan_premios_nacionales_bachillerato_establecidos.md) (Art. 24) desde *(Título IV, D. Adicional séptima. Centros sometidos al Derecho común.)*
- **Fundamentado en**: `norm-es-c-1978` (Art. 149, Art. 27) desde *(Título IV, D. Final primera. Título competencial.)*
...
- **Cita a**: [**LO8_1985 Ley Reguladora del Derecho a la Educacion (LODE)**](./LO8_1985_reguladora_derecho_educacion.md) (Art. 14)
- **Cita a**: [**LO2_2006 Ley Organica de Educacion**](../01_marco_normativo_general_y_organico/LO2_2006_educacion_texto_consolidado_modificaciones_lomloe.md) (Art. 111, Art. 114) desde *(Título I, Art. 2)*
- **Cita a**: [**BOE-A-2021-20113**](../03_ordenacion_curricular_y_ensenanzas/LO721_2021_correccion_errores_orden_efp_modifica_orden.md) (Art. 111, Art. 114) desde *(Título I, Art. 2)*
- **Cita a**: [**BOE-A-2010-12201**](../05_alumnado_y_servicios_escolares/LO2058_2010_edu_regulan_premios_nacionales_bachillerato_establecidos.md) (Art. 111, Art. 114) desde *(Título I, Art. 2)*
- **Cita a**: [**LO2_2006 Ley Organica de Educacion**](../01_marco_normativo_general_y_organico/LO2_2006_educacion_texto_consolidado_modificaciones_lomloe.md) desde *(Título I, Art. 3)*
- **Cita a**: [**LO8_1985 Ley Reguladora del Derecho a la Educacion (LODE)**](./LO8_1985_reguladora_derecho_educacion.md) desde *(Título I, Art. 3)*
- **Cita a**: [**BOE-A-2021-20113**](../03_ordenacion_curricular_y_ensenanzas/LO721_2021_correccion_errores_orden_efp_modifica_orden.md) desde *(Título I, Art. 3)*
- **Cita a**: [**BOE-A-2010-12201**](../05_alumnado_y_servicios_escolares/LO2058_2010_edu_regulan_premios_nacionales_bachillerato_establecidos.md) desde *(Título I, Art. 3)*
- **Cita a**: [**LO2_2006 Ley Organica de Educacion**](../01_marco_normativo_general_y_organico/LO2_2006_educacion_texto_consolidado_modificaciones_lomloe.md) (Art. 14) desde *(Título II, Art. 8)*
- **Cita a**: [**BOE-A-2021-20113**](../03_ordenacion_curricular_y_ensenanzas/LO721_2021_correccion_errores_orden_efp_modifica_orden.md) (Art. 14) desde *(Título II, Art. 8)*
- **Cita a**: [**BOE-A-2010-12201**](../05_alumnado_y_servicios_escolares/LO2058_2010_edu_regulan_premios_nacionales_bachillerato_establecidos.md) (Art. 14) desde *(Título II, Art. 8)*
