...
fuente_oficial: https://www.boe.es/buscar/act.php?id=BOE-A-2015-9462
clasificacion:
...
b) Se ha aplicado el procedimientos en la asignación del código de barras a los productos, identificando etiquetas normalizadas y códigos de barras.
...
3145. Actividades de apoyo a personas no dependienes en la unidad convivencial.
...
3073. Operaciones básicas de caldereria ligera.
...
Preparciación de los equipos de soldadura por arco eléctrico y oxiacetilénica:
...
a) Operaciones auxiliares de mantenimiento de elementos estructurales y de recubrimiento de superficies de embaraciones deportivas y de recreo TMV452_1 (Real Decreto 1225/2010, de 1 de octubre), que comprende las siguientes unidades de competencia:
...
b) Operaciones auxiliares de mantenimiento de sistemas y equipos de embaraciones deportivas y de recreo TMV453_1 (Real Decreto 1225/2010, de 1 de octubre), que comprende las siguientes unidades de competencia:
...
3048. Manteminiento básico de la planta propulsora y equipos asociados.
...
c) Se han sustituido elementos básicos de los sistema según especificaciones técnicas, comprobando la ausencia de fugas.
...
- **Desarrolla**: [**LO2_2006 Ley Organica de Educacion**](../01_marco_normativo_general_y_organico/LO2_2006_educacion_texto_consolidado_modificaciones_lomloe.md) desde *(Art. 1)*
- **Desarrolla**: [**BOE-A-2021-20113**](./LO721_2021_correccion_errores_orden_efp_modifica_orden.md) desde *(Art. 1)*
- **Desarrolla**: [**BOE-A-2010-12201**](../05_alumnado_y_servicios_escolares/LO2058_2010_edu_regulan_premios_nacionales_bachillerato_establecidos.md) desde *(Art. 1)*
