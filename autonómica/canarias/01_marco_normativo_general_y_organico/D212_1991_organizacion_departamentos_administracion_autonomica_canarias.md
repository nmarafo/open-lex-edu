...
Secretarías generales técnicas
	...
	a) elaborar las relaciones de puestos de trabajo integrando las propuestas de los demás órganos;
	b) formalizar las tomas de posesión y las diligencias de cese de los funcionarios;

	c) resolver sobre las comisiones de servicios que se desenvuelvan en el marco del Departamento y excedan del ámbito de un órgano de éste;
