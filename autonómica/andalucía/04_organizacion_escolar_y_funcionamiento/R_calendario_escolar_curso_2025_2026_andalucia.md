...
estado: Vigente
redaccion: original
fuente_oficial: https://www.juntadeandalucia.es/educacion/portals/web/ced/calendario-escolar
clasificacion:
...
Calendario escolar curso actual

### Modificación del horario escolar de un centro educativo

El Consejo Escolar de un centro puede iniciar el procedimiento para el cambio del modelo horario lectivo autorizado en el mismo, especificando el nuevo modelo que se quiera implantar. Para ello es necesario llevar a cabo una consulta entre todos los padres, madres o personas que ejerzan la tutela del alumnado que cursa enseñanzas en el centro, pues la decisión de la modificación del modelo requiere el voto favorable de la mayoría absoluta de estos.
...
Seleccione una provinciaAlmeríaCádizCórdobaGranadaHuelvaJaénMálagaSevilla
...
Ordenación de Enseñanzas de Régimen General

Comunidades de Aprendizaje

Inst. Andaluz de Cualificaciones Profesionales
...
Moodle (FP a distancia)

Centro Atención Usuarios (CAUCE)
...
Publicaciones Agencia Andaluza de Educación
